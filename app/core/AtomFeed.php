<?php
/*
 * AtomFeed.php - Simple PHP Atom Feed Generator
...
class AtomFeed {
	...
	const generator_name = "AtomFeed.php - A Simple PHP Atom Feed Generator";	
	...
	const generator_uri = "https://starbeamrainbowlabs.com/code/phpatomgenerator/"; 
	...
	public $id_uri = "http://localhost:8080/public/";	//the globally unique uri corresponding to the feed
	
	public $feed_uri = "http://localhost:8080/public/feedatom"; //the uri of the feed
